...
const DataGridT = () => {
    ...
    const handleSaveChanges = async () => {
        try {
            const response = await axios.put(`${apiUrl}/inventario/tipoTransaccion/${transaccionData.id}`, {
            ...
            < Dialog open={openModal} onClose={handleCloseModal} >
                ...
                <DialogContent>
                    <TextField
                        ...
                        onChange={(e) => setTransaccionData({ ...transaccionData, descripcion: e.target.value })}
                    />
                    <TextField
                        label={'categoria'}
                        fullWidth
                        ...
                        onChange={(e) => setTransaccionData({ ...transaccionData, categoria: e.target.value })}
                    />
                    ...
                    <FormControl fullWidth margin="normal">
                        ...
                        <Select
                            value={transaccionData.activo !== undefined ? transaccionData.activo : ''}
            ...
            < Dialog open={openModalPost} onClose={handleCloseModalPost} >
                ...
                <DialogContent>
                    <TextField
                        ...
                        onChange={(e) => setNewTransaccionData({ ...newTransaccionData, descripcion: e.target.value })}
                    />
                    <TextField
                        label={'Categoria'}
                        fullWidth
                        ...
                        onChange={(e) => setNewTransaccionData({ ...newTransaccionData, categoria: e.target.value })}
                    />
                    <FormControl fullWidth margin="normal">
                        <InputLabel>{'Rol'}</InputLabel>
                        <Select
